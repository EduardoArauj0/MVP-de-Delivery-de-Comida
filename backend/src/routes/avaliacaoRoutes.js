 ...
 * tags: [Avaliacoes]
 * security:
 * - bearerAuth: [] # Pode ser restrito a admin
 * responses:
 * 200:
 ...
 * 400:
 * description: Dados inválidos (ex: nota fora do range, PedidoId faltando)
 * 403:
 * description: Acesso negado (ex: tentando avaliar pedido de outro)
 * 404:
 ...
 * tags: [Avaliacoes]
 * security:
 * - bearerAuth: [] # Adicionar lógica de permissão no controller se necessário
 * parameters:
 * - in: path
 * name: id
 * schema:
